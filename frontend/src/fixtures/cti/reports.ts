...
export const reportsFixture: CtiReportsData = {
  reports: [
    {
      ...
      markers: [
        { label: "Critical", color: "rgba(239, 68, 68, 0.2)", textColor: "#ef4444" },
        { label: "Phishing", color: "rgba(59, 130, 246, 0.2)", textColor: "#60a5fa" },
      ],
    ...
    },
    {
      ...
      markers: [
        { label: "High", color: "rgba(251, 146, 60, 0.2)", textColor: "#fb923c" },
        { label: "Malware", color: "rgba(31, 41, 55, 0.6)", textColor: "#9ca3af" },
      ],
    ...
    },
    {
      ...
      markers: [{ label: "Medium", color: "rgba(250, 204, 21, 0.2)", textColor: "#facc15" }],
    ...
    },
    {
      ...
      markers: [
        { label: "Critical", color: "rgba(239, 68, 68, 0.2)", textColor: "#ef4444" },
        { label: "APT", color: "rgba(168, 85, 247, 0.2)", textColor: "#c084fc" },
      ],
    ...
    },
    {
      ...
      markers: [{ label: "Internal", color: "rgba(59, 130, 246, 0.2)", textColor: "#60a5fa" }],
  ...
  detail: {
    ...
    observablesCount: 42,
    observables: [
      { id: "obs-1", icon: "language", color: "#c084fc", value: "malicious-domain.com", type: "Domain Name" },
      { id: "obs-2", icon: "lan", color: "#60a5fa", value: "192.168.1.45", type: "IPv4 Address" },
      { id: "obs-3", icon: "fingerprint", color: "#fb923c", value: "a1b2c3d4e5...", type: "SHA-256" },
    ],
    relationships: [
      { id: "rel-1", icon: "groups", color: "#ef4444", label: "Threat Actor", value: "APT29" },
      { id: "rel-2", icon: "bug_report", color: "#60a5fa", label: "Malware", value: "Duke Family" },
    ],
